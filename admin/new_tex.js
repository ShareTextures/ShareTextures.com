...
var go = function(){
    ...
    function previewUploadedImg2(input) {
        if (input.files && input.files[0]) {
            var reader2 = new FileReader();
            reader2.onload = function(e) {
                $('#sphere-render2-preview').attr('src', e.target.result);
            }
    ...
    function previewUploaded2(input) {
        if (input.files && input.files[0]) {
            var reader2 = new FileReader();
            reader2.onload = function(e) {
                $('#sphere-render2-preview').attr('src', e.target.result);
    ...
    $("#sphere-render2").change(function() {
        previewUploaded2(this);
        $("#sphere-render2-preview-wrapper").removeClass("hidden");
    });


    $("#sphere-render2").change(function() {
        previewUploadedImg2(this);
        $("#sphere-render2-preview-wrapper").removeClass("hidden");
    });
